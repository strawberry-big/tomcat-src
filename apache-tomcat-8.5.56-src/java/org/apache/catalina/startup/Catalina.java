...
public class Catalina {
    ...
    public void load() {
        ...
        try {
            try {
                file = configFile();//CJ: G:\workspace\idea\tomcat\tomcat-src\apache-tomcat-8.5.56-src\home\conf\server.xml
    ...
    protected void initDirs() {
        String temp = System.getProperty("java.io.tmpdir");//CJ: C:\Users\Admin\AppData\Local\Temp\
