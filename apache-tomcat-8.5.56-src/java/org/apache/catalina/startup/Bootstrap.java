...
public final class Bootstrap {
    ...
    public void start() throws Exception {
        if (catalinaDaemon == null) { //CJ: Catalina Instance
            init();
        }
         ...
         * @author CJ
         * @data 20200625
         * 反射调用 Catalina.start 方法（Start a new server instance.）
         * 有过疑问为啥不直接调用start ：第一层 catalinaDaemon是Object对象没有start方法
         * 第二层 强转可以 ((Catalina)catalinaDaemon).start(); 那为啥呢？难道还有可能不是Catalina？
         */
